;app.detail=(function(){
    ...
    function init(id){
        ReactDOM.render(
            <SeatBox url="http://10.0.1.29:1111/seat" data={window.appData}   />,
            ...
            return (
                <div className="header-wrapper">
                    <div className="guest-info-wrapper" >
                        <img className="avatar" src={`images/${avatarJson[this.props.data.guest.number]}`} alt=""/>
                        <div className="info">
                            <div className="title">{this.props.data.guest.title}</div>
                            <div className="des">{this.props.data.guest.position} | {this.props.data.guest.company_name}</div>
                        </div>
                    </div>
    ...
    var SeatForm = React.createClass({
        ...
        handleSubmit: function(e) {
            ...
            var _this=this;
            var htmlStr=`
            <div id="go-pay" class="go-pay" style="display: none;">
                <div class="bg"></div>
                <div class="dialog">
                    <div class="coin"></div>
                    <div class="text">
                    <div class="title">每个时段只能预约一门课程哦~</div>
                    <div class="content">
                        确定预约 ${appData.course.guest.title} 老师<br>
                        ${appData.course.date} ${appData.course.start_time}-${appData.course.end_time} 分会场${appData.course.meetingplace} <br>
                        演讲主题《${appData.course.headline}》课程
                    </div>
                        ...
                        function showShare() {
                            ...
                            var successStr=`
                                <div id="go-book-success" class="go-book-success" >
                                    ...
                                    <div class="text-box">
                                      恭喜您，您已预约  ${appData.course.guest.title} 老师<br>
                                        ${appData.course.date} ${appData.course.start_time}-${appData.course.end_time} 分会场${appData.course.meetingplace} <br>
                                        演讲主题《${appData.course.headline}》课程
                                    </div>
        ...
        render: function() {
            ...
            if(this.props.data.length){
                var seatNodes = this.props.data.map((n,i)=> {
                    ...
                    var text=arr[0]+'排'+arr[1]+'座';
                    return (
                        <div className="btn btn-color-main seat-num" onClick={this.handleCancel} key={n}>
                            <span>{text}</span> <i className="i-course i-course-times"></i>
                        </div>
                    );
                });
                ...
                var seatBox= <div  className="selected-seat-box">
                    ...
                    <button className="btn btn-color-main" onClick={this.handleSelectRandom}>系统选座</button>
                ...
                <div className="book-wrapper" >
                    ...
                    <div className="info-box">
                        <div class="info-inner">
                            <div className="title">{this.props.courseData.guest.title}《{this.props.courseData.headline}》</div>
                            <div className="time">
                                2016年{this.props.courseData.date}
                                {this.props.courseData.start_time}-{this.props.courseData.end_time}
                                分会场{this.props.courseData.meetingplace}
                            </div>
                        </div>
                        {button}
                    </div>
