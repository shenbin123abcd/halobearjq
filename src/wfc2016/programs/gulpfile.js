...
(function(){
    ...
    if(window.appConfig.debug){
        ...
        window.appConfig.staticUrl=window.location.protocol+'//'+window.location.hostname+':9030/app/public';
    }else{
...
gulp.task('haloIcon', function () {
    return gulp.src('app/css/lib/ux_*/*iconfont.*')
        ...
        .pipe(gulp.dest('../../../Public/Wfc2016/programs/css'))
});
...
gulp.task('images',['css-s'], function () {
    return gulp.src(['app/images/**/*.{jpg,png,gif,svg}','!app/images/ico/*','!app/images/src/**/*'])
        ...
        .pipe(plugins.rev())
        .pipe(gulp.dest('../../../Public/Wfc2016/programs/images'))
        .pipe(plugins.rev.manifest())
        .pipe(gulp.dest('tmp/images'))
});


gulp.task('copy:programes:main', function () {
    return gulp.src(['app/main.html'])
        .pipe(gulp.dest('../../../Modules/Wfc2016/Tpl/Programs'))
});



gulp.task('build', ['sass','generateDistVersion','haloIcon','react','copy:programes:main'], function () {
    ...
    return gulp.src(['app/*.html','!app/main.html'])
        ...
        .pipe(plugins.cdnizer({
            // defaultCDNBase: "/Public/Wfc2016/programs",
            defaultCDNBase: "http://7ktq5x.com1.z0.glb.clouddn.com/Wfc2016/programs",
            allowRev: true,
            allowMin: true,
            matchers: [
        ...
        .pipe(plugins.uglify())
        .pipe(plugins.rev())
        .pipe(gulp.dest('../../../Public/Wfc2016/programs'))
...
gulp.task('copy:view', function () {
    ...
    return gulp
        ...
        .pipe(htmlFilter)
        .pipe(plugins.cdnizer({
            defaultCDNBase: "http://"+devip()[0]+":9030/app",
            //defaultCDNBase: "../",
            allowRev: true,
            allowMin: true,
            matchers: [
            ...
            files: [
                ...
                {
                    file: 'js/**/*.js',
                    cdn: "http://"+devip()[0]+":9030/tmp/js/${ filename }"
                },
                // 'js/**/*.js',
        ...
        // .pipe(plugins.cdnizer({
        //     defaultCDNBase: "http://"+devip()[0]+":9030/",
        //     //defaultCDNBase: "../",
        //     allowRev: true,
        //     allowMin: true,
...
gulp.task('clean', require('del').bind(null, [ 
    '../../../Public/Wfc2016/programs/*',
    '../../../Modules/Wfc2016/Tpl/Programs/*',
    'tmp/*',
],{force:true}));
...
gulp.task("watch:dev", ['browser-sync','copy:view','sass','copy:js'], function(){
    ...
    gulp.watch(['app/images/label/*.png'],function(event) {
        //console.log('File ' + event.path + ' was ' + event.type + ', running tasks...');
        gulp.start('css-s');
...
gulp.task('css-s', function () {
    var spriteData = gulp.src('app/images/label/*.png').pipe(plugins.spritesmith({
        imgName: 'sprite.png',
        ...
        cssVarMap: function (sprite) {
            sprite.name = 'programs-label-' + sprite.name;
        }
    }));
