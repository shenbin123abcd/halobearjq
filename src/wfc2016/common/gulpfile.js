...
(function(){
    ...
    if(window.appConfig.debug){
        ...
        window.appConfig.staticUrl=window.location.protocol+'//'+window.location.hostname+':9060/app/public';
    }else{
...
gulp.task('haloIcon', function () {
    return gulp.src('app/css/lib/ux_*/*iconfont.*')
        ...
        .pipe(gulp.dest('../../../Public/Wfc2016/common/css'))
});
...
gulp.task('images',['css-s'], function () {
    return gulp.src(['app/images/**/*.{jpg,png,gif,svg}','!app/images/ico/*','!app/images/src/**/*'])
        ...
        .pipe(plugins.rev())
        .pipe(gulp.dest('../../../Public/Wfc2016/common/images'))
...
gulp.task('build', ['sass','generateDistVersion','haloIcon','react'], function () {
    ...
    return gulp.src(['app/*.html'])
        ...
        .pipe(plugins.cdnizer({
            // defaultCDNBase: "/Public/Wfc2016/common",
            defaultCDNBase: "http://7ktq5x.com1.z0.glb.clouddn.com/Wfc2016/common",
            allowRev: true,
            allowMin: true,
            matchers: [
        ...
        .pipe(plugins.uglify())
        .pipe(plugins.rev())
        .pipe(gulp.dest('../../../Public/Wfc2016/common'))
        ...
        .pipe(gulp.dest('../../../Modules/Wfc2016/Tpl/Common'))
});
...
gulp.task('copy:view', function () {
    ...
    return gulp
        ...
        .pipe(htmlFilter)
        .pipe(plugins.cdnizer({
            defaultCDNBase: "http://"+devip()[0]+":9060/app",
            //defaultCDNBase: "../",
            allowRev: true,
            allowMin: true,
            matchers: [
                /(<video[\s\S]*?poster=["'])(.+?)(["'][\s\S]*?>)/gi,
                /(<img[\s\S]*?data-src=["'])(.+?)(["'][\s\S]*?>)/gi,
            ],
            files: [
                // Thi
                // s file is on the default CDN, and will replaced with //my.cdn.host/base/js/app.js
                ...
                {
                    file: 'js/**/*.js',
                    cdn: "http://"+devip()[0]+":9060/tmp/js/${ filename }"
                },
                // 'js/**/*.js',
        ...
        // .pipe(plugins.cdnizer({
        //     defaultCDNBase: "http://"+devip()[0]+":9060/",
        //     //defaultCDNBase: "../",
        //     allowRev: true,
        //     allowMin: true,
...
gulp.task('clean', require('del').bind(null, [ 
    '../../../Public/Wfc2016/common/*',
    '../../../Modules/Wfc2016/Tpl/Common/*',
    'tmp/*',
],{force:true}));
...
gulp.task('css-s', function () {
    var spriteData = gulp.src('app/images/count_num/*.png').pipe(plugins.spritesmith({
        imgName: 'sprite.png',
        ...
        cssVarMap: function (sprite) {
            sprite.name = 'common-sprite-' + sprite.name;
        }
    }));
